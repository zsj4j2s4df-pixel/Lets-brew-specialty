...
- **Bewaren in het scrollvlak, niet in het scherm.** Een punt is
  `y = clientY − phoneTop + phone.scrollTop`; bij scrollen verschuift alleen de
  `<g>` eromheen. Anders drijven de punten weg zodra je scrollt.
...
5. *maak de opdracht* levert **echte regeleinden**, geen letterlijke `\n`
